...
////		result += "]";
////		return result;
//		return "66666666666666666666666666663453453453";
//	}
//
...
//		ILDAO.editLeftNumber(parars[2] + "," + (leftCount - borrowCount));
//
//		return "[1]";
//	}
//
...
//
//		String record = ILDAO.getRecord(recordId);
//		if (record.equals("[]"))
//			return "[0]";
//
...
//
	...
	public static void main(String[] args) {
		...
		String result = "";
		// result=ILDAO.getDeviceList("ios");
		// result =
		// ILDAO.borrowItem("全栈攻城狮薛哥,13194949494,,羽毛球,一个长得很可爱的羽毛球希望不要轻易狗带,1");
//		result = ILDAO.returnItem("4");
